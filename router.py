...
class Router:
    def __init__(self, app):
        ...
        plan_bp8 = Blueprint('plan8', __name__ )
        ...
        plan_bp4.add_url_rule('/plan/rate/<int:id>', methods=['POST'], view_func=PlanView.rate_event)
        ...
        plan_bp7.add_url_rule('/event/rate/<int:id>', view_func=PlanView.get_event_rate)
        plan_bp8.add_url_rule('/event/categories', methods=['GET'], view_func=PlanView.get_categories)
        ...
        self.app.register_blueprint(plan_bp8)